...
public class Main1 {
    public static void main(String[] args) {
        ...
        // левый right - правый конец массива (индекс)
        // середина массива middle - середина массива, middle = left + (right - left)/2; (array.lenght / 2)
        // пока левый <= правый будем делать
        // искать элемент в левой или правой половине?
        // "сделать" новые left и right в зависимочсти от того, где оказался искомый элемент
